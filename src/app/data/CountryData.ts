...
},
{
  ...
  export const asiaCountries: CountryData[] = [
    ...
    { 
      ...
      feature_one:"Южная Корея — это сочетание традиций и современной жизни. Мы поможем вам получить визу без лишних сложностей.",
    ...
    { 
      ...
      feature_one:"Катар — страна роскоши, футуристической архитектуры и захватывающих пустынных пейзажей. Хотите насладиться сервисом мирового уровня? Мы упростим процесс получения визы.",
