...
export const europeCountries: CountryData[] = [
  { 
    ...
    feature_five:"",
    feature_six:"",
    feature_seven:"Альпы, музыка Моцарта и уютные города. Австрия – рай для любителей природы и культурного отдыха. Австрия",
  },
  { 
    nameof: "belgium",
    name: 'Бельгия',
  ...
  { 
    ...
    feature_five:"",
    feature_six:"",
    feature_seven:"Термальные источники, Дунай и уютный Будапешт. Венгрия известна своими оздоровительными курортами.",
  },
  { 
    nameof: "germany",
    name: 'Германия',
    ...
    feature_five:"",
    feature_six:"",
    feature_seven:"Современные мегаполисы, баварские замки и богатое культурное наследие. Германия – идеальный баланс традиций и технологий.",
  ...
  { 
    ...
    feature_five:"",
    feature_six:"",
    feature_seven:"Античные руины, Эгейское море и острова. Греция – страна мифов и безмятежного отдыха.",
  },
  { 
    nameof: "denmark",
    name: 'Дания',
  ...
  { 
    ...
    feature_seven:"Теплый климат, пляжи Средиземного моря и яркие фестивали. Испания приглашает на незабываемый отдых",
  },
  { 
    nameof: "italy",
    name: 'Италия',
    ...
    feature_five:"",
    feature_six:"",
    feature_seven:"Колыбель истории и искусства. Рим, Венеция и Флоренция – города, наполненные духом эпохи Возрождения. ",
  },
  { 
    nameof: "cyprus",
    name: 'Кипр',
  ...
  { 
    ...
    feature_five:"",
    feature_six:"",
    feature_seven:"Очаровательная Рига, песчаные пляжи Балтийского моря и национальные парки. Латвия – место для спокойного отдыха.",
  ...
  { 
    ...
    feature_five:"",
    feature_six:"",
    feature_seven:"Готическая архитектура Вильнюса, песчаные дюны Куршской косы и древние замки. Литва – маленькая страна с богатой историей",
  },
  { 
    nameof: "luxembourg",
    name: 'Люксембург',
  ...
  { 
    ...
    feature_five:".",
    feature_six:"",
    feature_seven:"Фьорды, северное сияние и дикая природа. Норвегия – страна для любителей природы и активного отдыха",
  },
  { 
    nameof: "poland",
    name: 'Польша',
    ...
    feature_six:"",
    feature_seven:"Исторические города, готическая архитектура и доступный отдых. Польша – идеальное сочетание культуры и природы.",
  },
  { 
    nameof: "portugal",
    name: 'Португалия',
    ...
    feature_six:"",
    feature_seven:"Атлантическое побережье, живописные города и винные традиции. Португалия – уютная жемчужина Европы.",
  },
  { 
    nameof: "romania",
    name: 'Румыния',
  ...
  { 
    ...
    feature_six:"",
    feature_seven:"Тысячи озер, сауна и Санта-Клаус. Финляндия дарит спокойствие и гармонию с природой.",
  },
  { 
    nameof: "france",
    name: 'Франция',
    ...
    pageUrl: '/visa/france',
    feature_one: "Виза в Францию позволяет многократные въезды в страну на протяжении срока действия визы, что удобно для частых поездок.",
    feature_two: "В зависимости от типа визы, пребывание в Францию может быть как краткосрочным, так и долгосрочным для работы или учебы.",
    feature_three: "Визы Франции дают возможность участвовать в деловых встречах, конференциях и других профессиональных мероприятиях.",
    feature_four: "С визой в Францию вы можете путешествовать по странам Шенгена, посещая различные страны и города без дополнительных ограничений.",
    feature_five: "",
    feature_six:"",
    feature_seven:"Романтика, мода и изысканная кухня. Париж, Лазурный берег и исторические замки ждут вас в сердце Европы.",
  },
  { 
    nameof: "croatia",
    name: 'Хорватия',
    ...
    feature_five: "",
    feature_six:"",
    feature_seven:"Бирюзовые воды Адриатики, национальные парки и средневековые города. Хорватия – идеальное место для пляжного отдыха.",
  },
  { 
    nameof: "czech",
    name: 'Чехия',
    ...
    feature_six:"",
    feature_seven:"Прага – город сказок, средневековые замки и термальные курорты. Чехия пленяет своей атмосферой.",
  ...
  },
  {
    ...
    feature_six: "",
    feature_seven: "Скандинавская природа, современные технологии и уютный стиль жизни. Стокгольм – город на воде."
},
{
  nameof: "switzerland",
  name: 'Швейцария',
  ...
  feature_six: "",
  feature_seven: "Горы, озера и часы. Швейцария – страна идеального порядка и потрясающей природы"
},
{
  nameof: "estonia",
  name: 'Эстония',
  ...
  feature_six: "",
  feature_seven: "Современные технологии, средневековый Таллин и живописные острова. Эстония сочетает историю и цифровую культуру."
}
];
  ...
  export const asiaCountries: CountryData[] = [
    ...
    { 
      nameof: "Саудовская Аравия",
      name: 'Саудовская Аравия',
      name_two: 'Саудовская Аравия',
      flagUrl: '/images/Flags/saudi.svg',
      backgroundImgUrl: '/images/Flags/saudi.svg',
      pageUrl: '/visa_page/saudi_arabia',
      feature_one:"  страна роскоши, футуристической архитектуры и захватывающих пустынных пейзажей. Хотите насладиться сервисом мирового уровня? Мы упростим процесс получения визы.",
      feature_two:"28 долларов США.",
      feature_three:"2–5 рабочих дней.",
      feature_four:"Лояльное отношение Болгарии к российским туристам. Страна одна из немногих ЕС, которая в 90% одобряет заявки и не затягивает сроки выдачи визы.",
