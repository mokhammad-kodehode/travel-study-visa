    ...
    <main className={styles.main}>
        ...
        <section className={styles.section_text_content}>
            <div className={styles.section_text_content_title}>Образовательные программы за рубежом</div>
                <p className={styles.description}>Мы создаем программы, которые позволяют не просто увидеть новые страны, но и <strong>погрузиться в их культуру</strong>, изучить язык, историю и традиции изнутри.
                </p>
                <p className={styles.description}>Наши курсы рассчитаны на тех, кто стремится расширить свои горизонты, открыть для себя мир знаний и культурных богатств,  <strong>улучшить навыки общения на иностранном языке</strong> и получить практический опыт в различных сферах жизни за рубежом. Каждая программа разработана с учетом современных образовательных методик и поддерживается   <strong><span className={styles.violet}>опытными преподавателями и гидами</span> </strong>..
                </p>
                <p className={styles.description}>Мы работаем с <strong>ведущими учебными заведениями </strong> и туристическими партнерами по всему миру, чтобы предложить вам только лучшие условия для обучения и путешествий. Независимо от того, хотите ли вы изучать язык, погружаться в историю или просто открыть для себя новые страны, мы создадим для вас программу, которая <strong><span className={styles.violet}>не просто вдохновит</span></strong>, но и <strong>изменит ваше восприятие мира.</strong>
