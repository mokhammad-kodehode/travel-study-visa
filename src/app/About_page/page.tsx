    ...
    <main className={styles.main}>
          ...
          <section className={styles.section_text_content}>
           ...
           <p className={styles.description}>
              ...
              <strong > Мы создали комплексную систему сопровождения для <span className={styles.violet}>туристических, образовательных и миграционных программ </span> по всему миру.
              </strong>
            </p>

            <p className={styles.description}>
              <strong>
                Мы выстраиваем <span className={styles.violet}>стабильные и доверительные отношения</span> с партнёрами в России и за рубежом,
              </strong> обеспечивая надёжность и прозрачность сотрудничества.
            
              <br /><br />Команда наших специалистов гарантирует 
              <strong><span className={styles.violet}> высокий уровень сервиса</span> на каждом этапе</strong>
            ...
            <p className={styles.description}>
              ...
              <br /><br />
              Мы работаем с клиентами со всего мира, предоставляя <strong>индивидуальный подход</strong>, гибкие решения и
              <strong > лучшие возможности для реализации ваших <span className={styles.violet}>международных</span> планов.</strong>
              <br /><br />
