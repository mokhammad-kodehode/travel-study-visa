    ...
    <main className={styles.main}>
      ...
      <section className={styles.section_text_content}>
        ...
        <p className={styles.description}>
            Планируете поездку в Лондон или Манчестер, мечтаете увидеть старинные замки, университеты Оксфорда и Кембриджа, прогуляться по набережной Темзы или попасть на концерты мировых звёзд?
            Наш международный визовый центр <strong>Travel & Study </strong>поможет воплотить эту мечту в реальность.
        </p>
        <p className={styles.description}>
            Мы оформим визу в Великобританию легко, <strong>быстро и без стресса </strong> — будь то туристическая, учебная, бизнес- или рабочая. Вам останется только выбрать направление, а всю остальную подготовку возьмут на себя наши специалисты.
        </p>
