  ...
  return (
    <main className={styles.main}>
      ...
      <section className={styles.section_text_content}>
        <div className={styles.section_text_content_title}> ВНЖ Болгарии <span>(На основании открытия торгового представительств. Выдается карта ВНЖ сроком на один год с последующим продлением.)</span></div>
