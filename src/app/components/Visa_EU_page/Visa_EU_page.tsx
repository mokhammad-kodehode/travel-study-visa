        ...
        <ul data-aos="fade-top" className={styles.process_list_two}>
          ...
          <li className={styles.process_list_two_item}>
            ...
            <ul>
              ...
              <li>
              Начинайте процесс заранее, особенно если у вас есть конкретные даты поездки либо примерный диапазон желаемых дат для путешествия.
              </li>
              <li>
              Необходимо подать документы минимум за месяц до поездки. Также учитывайте тот факт, что сейчас есть трудности с записью, поэтому обращайтесь к нам заблаговременно и мы с радостью запишем вас на ближайшие доступные слоты для записи в ручную либо при помощи нашего бота.
              </li>
            </ul>
          </li>
          <li className={styles.process_list_two_item}>
            ...
            <ul>
              <li>
              Ко времени записи подойти в визовый центр и пройти по бланку записи в зал ожидания, получить талон и ждать свою очередь в окошко для подачи документов . Нельзя опаздывать, лучше подойти заблаговременно, ибо при опоздании запись будет аннулирована.
              </li>
              <li>
          ...
          <li className={styles.process_list_two_item}>
            ...
            <ul>
              <li>
              После подачи документов запускается процесс рассмотрения. Начиная с 2023 года срок рассмотрения документов в консульствах стран Шенгенского соглашения занимает от 1 недели до 45 дней, в некоторых случаях может занять больше времени. 
              </li>
              <li>
