      ...
      <section className={styles.banner} style={bannerStyle}>
        ...
        <ul className={styles.process_list_two}>
          ...
          <li>
            ...
            <span>
            После подачи документов запускается процесс рассмотрения. Сейчас срок рассмотрения документов в консульстве занимает от от 2 недель до 45 дней  дней, но в некоторых случаях может занять больше времени.
            </span>
          </li>
          <li>
